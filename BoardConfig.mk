...
DEVICE_PATH := device/samsung/kltekor
...
# Build Fingerprint
BUILD_FINGERPRINT := samsung/kltektt/kltektt:6.0.1/MMB29M/G900KKTU1CPL5:user/release-keys
...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_kltekor
